...
const decorateOrder = (order) => {
	...
	return({
		...
		tokenPrice,
		formattedTimestamp: moment.unix(order.timestamp).format('hh:mm:ss a DD/MM/YYYY')
	})
}
...
const tokenPriceClass = (tokenPrice, orderId, previousOrder) => {
	...
	// show green price if order price higher then previous order
